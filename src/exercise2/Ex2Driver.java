...
//  task9(); //i think I have the correct code I just couldn't get it to run
//  task10(task9()); // I think the code is correct just couldn't get it to run
  }
...
//  throw new UnsupportedOperationException("Task 5 is not implemented yet.");
  ...
  public static void task6() {
    ...
    while (input != 0.0) {
        arr.add(input);
        System.out.println("Please enter another integer (and 0 if done): ");
...
//  throw new UnsupportedOperationException("Task 8 is not implemented yet.");
   ...
   * @return 
   */
  public static int[][] task9(int r, int c) {
      System.out.println("");
